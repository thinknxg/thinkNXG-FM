...
- thinknxg Password Management: v0.0.1 (master)
- Wiki: v15 (master-15)
...
``` bash
bench get-app https://github.com/thinknxg/thinknxg-FM.git
bench install-app thinknxg-fm
```
